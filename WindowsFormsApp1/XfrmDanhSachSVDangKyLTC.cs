    ...
    public partial class XfrmDanhSachSVDangKyLTC : Form
    {
        ...
        cbKhoa.SelectedValue == null)
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("sp_SinhVienLTC_report", conn);
                ...
                cmd.Parameters.AddWithValue("@MONHOC", cbMonHoc.SelectedValue.ToString());
                ...
                rptSinhVienDangKyLTC rpt = new rptSinhVienDangKyLTC();
        ...
        private void XfrmDanhSachSVDangKyLTC_Load(object sender, EventArgs e)
        {
            loadHocKy();
            loadMonHoc();
            loadNienKhoa();
